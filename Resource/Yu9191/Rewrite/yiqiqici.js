...
项目名称：一起欺词
软件版本：2.4
下载地址：https://is.gd/vqx7wY
使用声明：⚠️仅供参考，🈲️转载与售卖！

**************************************

[rewrite_local]
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-response-body https://raw.githubusercontent.com/axtyet/comet_scripts/main/Resource/Yu9191/Rewrite/yiqiqici.js
...
if (typeof $response == "undefined") {
  ...
  anni1.subscriber.subscriptions["hurtyou_199_1y"] = data;
  anni1.subscriber.entitlements["premium"] = JSON.parse(JSON.stringify(data));
  anni1.subscriber.entitlements["premium"].product_identifier = "hurtyou_199_1y";
