...
^https:\/\/buy\.itunes\.apple\.com\/verifyReceipt url script-response-body https://raw.githubusercontent.com/axtyet/comet_scripts/main/Resource/Yu9191/Rewrite/itunes/bbaabbyy.js
...
let product_id;
if (ua.indexOf('EnglishTalent/1077') !== -1) {
    product_id = 861803675;    
} else if (ua.indexOf('EnglishTalent/438') !== -1) {
    product_id = 953738100;  
} else {
    product_id = "Bodypro1"; 
