...
西江诗词：https://apps.apple.com/app/id1084924739

[rewrite_local]
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-response-body https://raw.githubusercontent.com/axtyet/comet_scripts/main/Resource/Guding88/Script/xijiangshici.js
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-request-header https://raw.githubusercontent.com/axtyet/comet_scripts/main/Resource/Guding88/Script/xijiangshici.js
...
if (typeof $response == "undefined") {
  ...
  const app = 'gd';const list = {'gd':{name: 'Pro Lifetime', id: 'com.uzero.poem.life1'}};
  const data = {
