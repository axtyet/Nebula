...
Weather Fit：https://apps.apple.com/app/id1194408342

[rewrite_local]
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-response-body https://raw.githubusercontent.com/axtyet/comet_scripts/main/Resource/Guding88/Script/WeatherFit.js
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-request-header https://raw.githubusercontent.com/axtyet/comet_scripts/main/Resource/Guding88/Script/WeatherFit.js
...
if (typeof $response == "undefined") {
  ...
  const app = 'gd';const list = {'gd':{name: 'Pro', id: 'com.antonchuiko.wthrd.premium_onetime'}};
  const data = {
