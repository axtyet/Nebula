...
Clockology：https://apps.apple.com/app/id1456386228

[rewrite_local]
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-response-body https://raw.githubusercontent.com/axtyet/comet_scripts/main/Resource/Guding88/Script/Clockology.js
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-request-header https://raw.githubusercontent.com/axtyet/comet_scripts/main/Resource/Guding88/Script/Clockology.js
...
if (typeof $response == "undefined") {
  ...
  const app = 'gd';const list = {'gd':{name: 'Clockology+', id: 'com.mikehill.clockologyios.yearly'}};
  const data = {
