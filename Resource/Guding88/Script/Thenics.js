...
Thenics：https://apps.apple.com/app/id1509531048

[rewrite_local]
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-response-body https://raw.githubusercontent.com/axtyet/comet_scripts/main/Resource/Guding88/Script/Thenics.js
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-request-header https://raw.githubusercontent.com/axtyet/comet_scripts/main/Resource/Guding88/Script/Thenics.js
...
if (typeof $response == "undefined") {
  ...
  const app = 'gd';const list = {'gd':{name: 'pro', id: 'pro_yearly_subscription_ios'}};
  const data = {
